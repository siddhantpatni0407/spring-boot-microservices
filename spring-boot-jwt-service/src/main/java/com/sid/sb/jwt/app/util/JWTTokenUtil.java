...
import com.sid.sb.jwt.app.config.ApplicationProperties;
...
public class JWTTokenUtil {
	...
	private String doGenerateToken(Map<String, Object> claims, String subject) {
		Header header = (Header) Jwts.header();
		header.setType("JWT");
		return Jwts.builder().setHeader((Map<String, Object>) header).setClaims(claims).setSubject(subject)
				.setIssuer("Siddhant_Patni").setIssuedAt(new Date(System.currentTimeMillis()))
