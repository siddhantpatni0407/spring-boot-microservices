...
public class DataGeneratorService {
    ...
    public String generateCSVData() {
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            return "Customer data has been generated and saved to database";
            ...
            throw new CustomException(HttpStatus.INTERNAL_SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR.value(), "Exception occurred while generating the CSV data. Exception -> {}", exception);
        }
    }
